...
import com.mhl.utils.DruidUtils;
...
public class BasicDAO<T> {
     ...
     * dml 操作，所有表可用
     *
     * @param sql    sql 查询语句 可以存在 ? 占位符
     * @param params ? 占位符 具体赋值
     * @return
     */
    public int update(String sql, Object... params) {
        ...
        try {
            ...
            // PreparedStatement, ResultSet 都已经在 update 方法底层被 close() 释放，所以这里只需要关闭 connection
     ...
     * @return 根据传入的 xxx.class 返回对应的 ArrayList 集合
     */
